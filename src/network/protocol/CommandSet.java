...
public class CommandSet implements Constants {
	public static HashSet<String> supportedCommands = new HashSet<String>(Arrays.asList(VERSION, 
			NEWPLAYER, NEWPLAYERACCEPTED, GETOPTIONS, OPTIONS, PLAY,
			WAITFOROPPONENT, GAMESTART, MOVE, GETBOARD, BOARD, QUIT, GAMEOVER,
			CHAT, CHALLENGE, AVAILABLEPLAYERS, YOUVECHALLENGED, YOURECHALLENGED,
			TWOPASS, TERRITORYSCORING, CHALLENGEACCEPTED, CHALLENGEDENIED, FAILURE));
	public static HashSet<String> supportedArguments = new HashSet<String>(Arrays.asList(WHITE, 
			BLACK, PASS, VICTORY, DEFEAT, W, B, E, CHAT, CHALLENGE, OBSERVER, COMPUTERPLAYER));
	...
	public static HashSet<String> errors = new HashSet<String>(Arrays.asList(UNKNOWNCOMMAND,
			...
			ILLEGALCHARACTERS, OTHERPLAYERCANNOTCHAT, PLAYERNOTAVAILABLE,
			GAMENOTPLAYING));
